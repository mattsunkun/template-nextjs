...
export class PhaseManager {
    ...
    async create(){
        ...
        this.memoryPhaseManager = new MemoryPhaseManager(this.scene, cardKnownInfo, this.turnManager, this.gameClient);
    }


    // onCardClicked(cardComponent: MemoryCardComponent) {
    //     switch (this.currentPhase) {
    //         case GamePhase.MEMORY_GAME:
    //             this.memoryPhaseManager.onCardClicked(cardComponent);
    //             break;
    //     }
    // }
